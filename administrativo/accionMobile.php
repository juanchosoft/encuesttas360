...
<div class="menu-container">
    ...
    <div class="menu-section">
        ...
        <div class="menu-grid">
            <a href="departamentos.php" class="menu-item-mobile">
            ...
            <a href="municipios.php" class="menu-item-mobile">
                <div class="icon-mobile">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M21 10c0 6-9 12-9 12s-9-6-9-12a9 9 0 0 1 18 0z" />
            ...
            <a href="ingreso_factores.php" class="menu-item-mobile">
                <div class="icon-mobile">
                   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <path d="M19 3v4m-2-2h4" stroke="#3B82F6" />
                    </svg>
                </div>
            ...
            <a href="ingreso_informacion.php" class="menu-item-mobile">
                <div class="icon-mobile">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <path d="M18 6v3h3" stroke="#3B82F6"></path>
            ...
            <a href="ingreso_informacion_listado.php" class="menu-item-mobile">
                <div class="icon-mobile">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <path d="M19 16v3m0 0l-1.5-1.5M19 19l1.5-1.5" stroke="#3B82F6"/>
                        <path d="M17 5l2-2 2 2" stroke="#10B981"/>
                        <circle cx="19" cy="8" r="1" fill="#10B981" stroke="none"/>
                    </svg>
                </div>
            ...
            <a href="actualizacion_informacion.php" class="menu-item-mobile">
                <div class="icon-mobile">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <path d="M18 15l2 2-2 2m2-4h-4" stroke="#3B82F6" stroke-width="2"/>
                    </svg>
                </div>
