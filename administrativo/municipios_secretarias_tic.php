...
if (isset($_REQUEST['mun'], $_REQUEST['dep']) && !empty(trim($_REQUEST['mun'])) && !empty(trim($_REQUEST['dep']))) {
    ...
    $secretariasMunicipioProyectos = MunicipioSecretaria::getProyectosPorSecretariaByMunicipioIdBySecretariaId(array('municipioId' => $municipio, 'secretariaId' => Util::getSecretariaIdTIC()));
} else { ?>
<script type='text/javascript'>
    alert('Información enviada no es correcta');
    window.location =
        'tic_dash.php?mun=<?php echo Util::getCodigoMunicipioPrincipal(); ?>&opcion=<?php echo Util::getOpcionPrincipalTIC(); ?>';
</script>
<?php
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Municipio secretaría TIC</h5>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-4">
                                                <select onchange="MUNICIPIO.updateUrlMunicipio(this)"
                                                    class="form-control" id="tbl_municipio_id"
                                                    name="tbl_municipio_id"></select>                                                <label for="tbl_municipio_id">Municipio</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
