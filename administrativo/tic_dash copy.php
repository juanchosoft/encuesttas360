            ...
            <div class="row">
                <div class="card-body">
                    <h4 class="text-center mb-4" style="font-size: 28px;">
                        <i style="color:red" data-feather="map-pin"></i> Filtrar por Municipios
                    </h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <button type="button" class="btn  btn-primary" data-toggle="modal"
                                    data-target="#modalGeocalizacion">Geolocalización</button>
                                <center>
                                    <h4>Filtrar por opciones</h4>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="validationCustom05">Opciones<span
                                                ...
                                                <select onchange="TIC_DASHBOARD.updateUrlOpcion(this)" ;
                                                    ...
                                                    <option value="computadores_institucion">Computadores
                                                        Institución</option>
