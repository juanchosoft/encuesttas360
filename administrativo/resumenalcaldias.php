...
// ESTO ES LO QUE REDIRIGE PARA QUE SE MUESTRE EL MAPA PERO SE DEBE HACER UNO ESPECIFICO PARA SECRETARIAS 
if (!isset($_GET['depto_id'])) {
    header("Location: resumenalcaldias.php?depto_id=" . Util::getIdentificadorDepartamentoPrincipal() . "#!");
    exit;
}
  ...
  cursor: pointer;
    ...
    <div class="content">
        <div class="row mb-4 mb-xl-6 mb-xxl-4 gy-3 justify-content-between">
          <div class="col-auto">
            <h2 class="mb-0 text-body-emphasis">Resumen Alcaldias</h2>
          </div>
          <div class="col-auto">
          </div>
        </div>
          ...
          <div class="col-xxl-20">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="form-floating mb-4">
                    ...
                    <label for="tbl_secretarias_id">Elige Alcaldia</label>
                </div>
                </div>
                <!-- SUBMENU DE ESTADOS -->
                ...
                <div class="tab-pane fade show active" id="Soto_Norte" role="tabpanel" aria-labelledby="Soto_Norte-tab">
                    <div class="row text-center gx-3 gy-2 mb-4">
                        ...
                        <div class="col-12 col-md-4">
                        <div class="d-flex align-items-center justify-content-center flex-column p-3 bg-body border rounded-3 shadow-sm h-100">
                            <i class="fa-solid fa-chart-line fs-4 text-warning mb-1"></i>
...
<div class="row g-4 mb-4">
  ...
  <div class="col-xl-9 col-lg-8">
    <div class="card shadow-none border" data-component-card="data-component-card">
      <div class="card-header p-4 border-bottom bg-body d-flex justify-content-between align-items-center">
  ...
  <!-- Columna de Colores y Puntaje -->
  <div class="col-xl-3 col-lg-4">
    <div class="card h-100 shadow-sm border">
      <div class="card-header text-center">
        <h5 class="mb-0 d-flex align-items-center justify-content-center gap-2">
          <i class="bi bi-sliders2-vertical text-secondary fs-5"></i> Colores y Puntaje
        </h5>
      </div>
      <div class="card-body">
        <table class="table tabla-colores text-center align-middle mb-0">
          <thead>
            <tr>
              <th>Desde</th>
              <th>Hasta</th>
          ...
          <tbody>
            <tr>
              <td>0</td>
              <td>0</td>
              <td><span class="color-circle" style="background-color: white !important;"></span></td>
            </tr>
            <tr>
              <td>1</td>
              <td>400</td>
              <td><span class="color-circle" style="background-color: #FF00FF !important;"></span></td>
            </tr>
            <tr>
              <td>401</td>
              <td>&rarr;</td>
