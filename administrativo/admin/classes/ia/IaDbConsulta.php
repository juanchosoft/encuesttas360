...
class IaDbConsulta
{
    ...
    private const TABLAS_PERMITIDAS = [
        ...
        'tbl_certificacion_encuestador', 'tbl_cuestionario_intentos', 'tbl_cuestionario_respuestas',
