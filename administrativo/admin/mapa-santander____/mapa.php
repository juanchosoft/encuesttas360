    ...
    <div class="row">
      <div class="col-sm-4">
        <div class="form-horizontal">
          <table class="table table-sm">
            <tr>
                <h5 class="titu-Consolidado text-center">Total de Apoyos</h5>
            </tr>
            <tbody>
              <?php
              $c = count($arr2021);
              ...
              <tr>
                <td>
                  <span class="elementcolor"
                    style="background-color: <?php echo $arr2021[$i]['color2021']; ?>"></span><?php echo $arr2021[$i]['CuentaDecolor']; ?>
                  VEREDAS
                </td>
      ...
      <div class="col-sm-4">
        <div class="form-horizontal">
          <table class="table table-sm">
            <tr>
                <h5 class="titu-Consolidado text-center">Población Habilitada para votar</h5>
            </tr>
            <tbody>
              <?php
              $c = count($arr2021);
