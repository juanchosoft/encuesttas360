...
<div class="menu-container">
    ...
    <div class="menu-section">
        ...
        <div class="menu-grid">
            <a href="secretaria.php" class="menu-item-mobile">
            ...
            <a href="dash_secretarias.php" class="menu-item-mobile">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                        ...
                        <path d="M8 21h8"/>
                        <path d="M12 17v4"/>
                        <rect x="6" y="7" width="3" height="6"/>
                        <rect x="11" y="9" width="3" height="4"/>
                        <rect x="16" y="6" width="3" height="7"/>
                    </svg>
                </div>
                <div class="label-mobile">Dashboard secretarías</div>
            </a>
        </div>
    </div>
