  ...
  <body>
            ...
            <div class="card shadow-none border my-4" data-component-card="data-component-card">
              <div class="card-header p-4 border-bottom bg-body">
                <div class="row g-3 justify-content-between align-items-center">
                  ...
                  <i style="color:black !important;font-size: 1.9rem !important;" class="uil uil-user me-2 fs-4 text-primary"></i> Ingreso de información
                  </div>
                </div>
              </div>
                ...
                <div class="p-4 code-to-copy">
                  ...
                  <form class="row g-3 mb-6" id="formusuarios" role="form" autocomplete="false">
                    ...
                    <div class="col-sm-10 col-md-12 d-flex justify-content-center">
                        <button type="button" class="btn btn-primary d-flex align-items-center gap-2" onclick="abrirModal();">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="form-floating" style="width: 100%; max-width: 800px;">
                            <textarea class="form-control" id="observaciones"
                                    name="observaciones" placeholder=""></textarea>                       
    ...
    <!-- MODAL GEOLOCALIZACIÓN -->
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            ...
            <div class="modal-body">
                ...
                <div class="form-check" style="display: flex; align-items: center; gap: 0.4rem;">
                    ...
                    <label class="form-check-label" for="trafficLayerToggle" >Capa de Tráfico</label>
                </div>
                <div class="form-check" style="display: flex; align-items: center; gap: 0.4rem;">
                    <input class="form-check-input" type="checkbox" id="transitLayerToggle">
                    <label class="form-check-label" for="transitLayerToggle" >Capa de Transporte Público</label>
                </div>
                <div class="form-check" style="display: flex; align-items: center; gap: 0.4rem;">
                    <input class="form-check-input" type="checkbox" id="bicycleLayerToggle">
                    <label class="form-check-label" for="bicycleLayerToggle" >Capa de Bicicleta</label>
                </div>
                <div class="form-check" style="display: flex; align-items: center; gap: 0.4rem;">
                    <input class="form-check-input" type="checkbox" id="terrainToggle">
                    <label class="form-check-label" for="terrainToggle" >Mostrar Terreno</label>
                </div>
                </div>



                <!-- Coordenadas en horizontal con estilos inline -->
        ...
        function abrirModal() {
            ...
            const latitud = $("#latitud").val() || LATITUD;
            const longitud = $("#longitud").val() || LONGITUD;
            const factorClass = $("#factorId").find(":selected").attr("class") || "assets/iconos/maps/geo.png";
