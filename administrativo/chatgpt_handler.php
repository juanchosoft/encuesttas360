...
if ($response === false) {
    echo json_encode(['response' => 'Hubo un error al conectar con SANTAI.']);
    exit;
}

$responseData = json_decode($response, true);
$chatGptResponse = $responseData['choices'][0]['message']['content'] ?? 'No se obtuvo respuesta de SANTAI.';
...
// $apiKey = $_ENV['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'];
...
//     'model' => 'gpt-4', // Usa GPT-4 como modelo
//     'messages' => [
//         [
//             'role' => 'system',
...
// echo "Respuesta del ChatGPT: " . $response['choices'][0]['message']['content'] . PHP_EOL;
