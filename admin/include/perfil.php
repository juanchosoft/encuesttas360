<?php
$perfilUserId = isset($_SESSION['session_user']['id']) ? (int)$_SESSION['session_user']['id'] : 0;
?>
<!-- Modal Perfil -->
<div class="modal fade" id="perfilModal" tabindex="-1" aria-labelledby="perfilModalLabel" aria-hidden="true" data-profile-id="<?php echo $perfilUserId; ?>">
        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius:12px;">
            ...
            <div class="modal-body px-4 pb-4">
                ...
                <form id="formPerfilUpdate">
                    ...
                    <input type="hidden" name="idVotantes" id="idVotantes_perfil" value="<?php echo $perfilUserId; ?>" />
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <small class="text-muted">Opcional. Solo si deseas cambiar tu contraseña</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="password" class="form-control form-control-sm" id="password_perfil" 
                                name="password" placeholder="Contraseña nueva (opcional)">
