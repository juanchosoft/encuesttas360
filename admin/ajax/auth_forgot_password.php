...
// Carga las clases necesarias con rutas absolutas
$baseDir = dirname(__DIR__); // /admin
require_once $baseDir . '/classes/Util.php';
require_once $baseDir . '/classes/DbConection.php';
require_once $baseDir . '/include/mail_config.php';
require_once $baseDir . '/include/mailer.php';
...
try {
   ...
   */
  // Replicar flujo: login_process hace md5(), Login.php hace make_hash_pass()
  $savePass = Util::make_hash_pass(md5($tempPass));
